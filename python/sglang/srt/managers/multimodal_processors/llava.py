...
from sglang.srt.models.llava import LlavaMistralForCausalLM, LlavaQwenForCausalLM, LlavaForConditionalGeneration
...
class LlavaImageProcessor(BaseMultimodalProcessor):
    models = [LlavaVidForCausalLM, LlavaQwenForCausalLM, LlavaMistralForCausalLM, LlavaForConditionalGeneration]
